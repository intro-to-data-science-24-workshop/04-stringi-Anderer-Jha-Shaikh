...
--
  ...
  - But ultimately text is data! Stringology [Crochemore and Rytter 2003](https://www.sciencedirect.com/science/article/pii/S030439750200590X) deals with algorithms and data structures for character string processing [Jurafsky and Martin 2008; Szpankowski 2001](https://www.researchgate.net/publication/200111340_Speech_and_Language_Processing_An_Introduction_to_Natural_Language_Processing_Computational_Linguistics_and_Speech_Recognition)
...
- A growing body of research in comparative politics make use of text mining and regular expressions:
  ...
  - Volkens et al. (2013), in their work on the Manifesto Project Database, provide a rich collection of political party manifestos from over 50 countries. 
      - Researchers analyze the frequency and sentiment of keywords or phrases related to specific policies (e.g., "welfare," "tax cuts," "immigration") in these manifestos to measure ideological shifts.
      
  - Hawkins et al. (2018) examined populist rhetoric in the speeches of political leaders in countries like the United States, Venezuela, and Hungary.
      - Textual analysis involved detecting populist phrases, counting occurrences, and comparing populist rhetoric across leaders and countries.
      
  - Soroka (2012) conducted a comparative study of media coverage of elections in the United States, United Kingdom, and Canada.
      - Media articles are analyzed for issue framing (e.g., economy, healthcare, immigration) and tone (positive/negative) toward political candidates.
