...
**Working with temporal data from different locales**: use `stri_datetime_parse`to homogenize temporal data. 
--
<br>
...
**General Transforms**: use `stri_trans_general` to transliterate characters from one script to another script of your choosing. 
--
<br>
